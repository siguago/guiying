...
pub use model::{
    ...
    SampleBucketCursor, ScanCheckpointInput, ScanCheckpointRecord, ScanControlDisposition,
    ScanControlKind, ScanControlRequestInput, ScanControlRequestKey, ScanControlRequestRecord,
